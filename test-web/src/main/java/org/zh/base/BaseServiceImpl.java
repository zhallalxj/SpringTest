...
import org.zh.utils.SpringContextUtil;
...
/**
 * 
 * @Description:TODO(实现BaseService抽象类)   
 * @author: level.meng 
 * @date:   2017年2月16日 下午4:46:29   
 *   
 * @param <Mapper>
 * @param <Record>
 * @param <Example>  
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example,Long> {
