...
<div id="wrapper" style="height: 100%">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="index.html"><img src="${basePath}/static/assets/img/logo-dark.png" alt="Klorofil Logo"
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img
                                src="${basePath}/static/assets/img/user.png" class="img-circle" alt="Avatar"> <span>Samuel</span>
